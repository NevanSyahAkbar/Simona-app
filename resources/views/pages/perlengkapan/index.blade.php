                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Kode Perlengkapan</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($perlengkapan as $item)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-800 max-w-xs whitespace-normal break-words">{{ $item->kode_perlengkapan }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        ...
                                        {{-- PERUBAHAN: Tombol Edit selalu tampil --}}
