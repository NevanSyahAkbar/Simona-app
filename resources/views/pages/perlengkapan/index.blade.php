    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                {{-- PERBAIKAN: Menambahkan div wrapper untuk scroll --}}
                <div class="relative overflow-x-auto max-h-[60vh] border rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($perlengkapan as $item)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">{{ $perlengkapan->firstItem() + $loop->index }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('perlengkapan.show', ['perlengkapan' => $item->id, 'row' => $perlengkapan->firstItem() + $loop->index]) }}" class="text-indigo-600 hover:text-indigo-900">View</a>
